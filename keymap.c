...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  ADJUST,    KC_NUHS,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT, \
      ARROW, KC_LGUI, KC_LALT, KC_LGUI, KC_UP,   LOWER,  KC_SPC,   KC_SPC,  RAISE,   KC_LBRC, KC_RBRC,  KC_RALT, KC_APP , KC_RCTL \
      ),
  [_LOWER] = LAYOUT( \

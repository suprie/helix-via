...
#define QFULL DF(_QWERTY_FULL)

#define CTLGUISFT MT(MOD_LCTL|MOD_LGUI|MOD_LSFT , KC_NO)
#define CTLGUIALT MT(MOD_LCTL|MOD_LGUI|MOD_LALT, KC_NO)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_QWERTY_FULL] = LAYOUT( \
      ...
      KC_LCTL, KC_LOPT, CTLGUISFT,  CTLGUIALT, GUI_NUBS, BKSP_LOW, KC_SPACE, KC_SPACE ,ENTRAI, KC_NUBS, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT \
      ),
 [_QWERTY] = LAYOUT( \
...
[_COLEMAK] = LAYOUT( \
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, QWERTY, _______, _______,    QFULL, _______,                    _______, _______, _______, _______, _______, _______, \
      _______, _______, _______, COLEMAK, _______, _______, _______, _______, _______, _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, \
...
static void render_layer_state(int layer) {
    switch (get_highest_layer(layer)) {
        ...
        case _QWERTY_FULL: oled_write("FULL ", true); break;
